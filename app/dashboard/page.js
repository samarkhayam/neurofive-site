    ...
    <div className="px-6 py-8 lg:px-10 pb-24 lg:pb-8">
        ...
        <div className="mb-6 flex items-center justify-between gap-4 rounded-xl border border-brand-accent/30 bg-brand-accent/5 px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-brand-muted">All tasks approved — download now</p>
            </div>
          </div>
          <Link
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <i
            className={`fa-solid ${allApproved ? 'fa-certificate text-brand-accent' : 'fa-lock text-brand-muted'} transition-colors group-hover:text-brand-accent`}
            aria-hidden="true"
          />
        </Link>
      </div>
